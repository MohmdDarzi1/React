...
import {
  selectLoginRequestModal,
  toggleLoginRequestModal,
} from "../../../../redux/slices/LoginRequestModal";
...
const LoginRequest = () => {
  const open = useSelector(selectLoginRequestModal);
  ...
  return (
    <Modal
      ...
      // Login={Login}
      // Login={Login}
      onClose={() => dispatch(toggleLoginRequestModal())}
